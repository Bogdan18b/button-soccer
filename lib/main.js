...
const playerMove = () => {
  ...
  const draw = () => {
    ...
    let player1 = new Player(ctx, playerX, playerY, playerRadius, "#FF0000", "#0000FF", playerVelocity, "A");
    let player2 = new Player(ctx, playerTwoX, playerTwoY, playerTwoRadius, "#FFFFFF", "#FF0000", playerVelocity, "B");
    let player3 = new Player(ctx, player3X, player3Y, computerRadius, "#FFFFFF", "#FF0000", computerPlayerVelocity, "B");
    let goalkeeper1 = new Player(ctx, keeperOneX, keeperY, playerRadius, "#FF0000", "#0000FF", playerVelocity, "A");
    let goalkeeper2 = new Player(ctx, keeperTwoX, keeperY, playerRadius, "#FFFFFF", "#FF0000", playerVelocity, "B");
    ball.onField(w, h);
    player3.onField(x, y);
    playerMove();
    moveKeepers();
