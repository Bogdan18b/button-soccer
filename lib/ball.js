class Ball {
  ...
  onField(w, h) {
    if (((this.y + this.velocity.y < h/2 - 100 + this.radius || this.y + this.velocity.y > h/2 + 100 + this.radius) && this.x + this.velocity.x > w - 50 - this.radius) ||
      ((this.y + this.velocity.y < h/2 - 100 + this.radius || this.y + this.velocity.y > h/2 + 100 + this.radius) && this.x + this.velocity.x < 50 + this.radius)) {
